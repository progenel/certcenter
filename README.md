...
Внутренний CA и сервис шифрования для МСП. Быстрый запуск для демонстрации: SQLite + локальное хранилище артефактов, JWT-логин, роли admin/officer/user, выдача реальных X.509 (cryptography), CRL.
...
- Артефакты: cert PEM/P12, chain (stub), CRL (реальный), envelope заглушка.
...
## Сборка документации
PlantUML → SVG, потом AsciiDoc; PDF — в bindoc.
